...
-- Add Average Item Level to Tooltip
...
iLvLFrame:SetScript('OnEvent', function(self, event, ...) return self[event](self, event, ...) end)
iLvLFrame:Hide()
...
iLvLFrame:SetScript('OnUpdate', function (self, elapsed)
...
function iLvLFrame:INSPECT_READY (_, guid)
...
function iLvLFrame:UNIT_INVENTORY_CHANGED (_, unit)
...
function iLvLFrame:PLAYER_REGEN_DISABLED ()
	inCombat = true
end
iLvLFrame:RegisterEvent('PLAYER_REGEN_DISABLED')

function iLvLFrame:PLAYER_REGEN_ENABLED ()
	inCombat = nil
end
iLvLFrame:RegisterEvent('PLAYER_REGEN_ENABLED')

function iLvLFrame:PLAYER_LOGIN ()
...
if ( IsLoggedIn() ) then
	iLvLFrame:PLAYER_LOGIN()
	inCombat = InCombatLockdown()
	return OnTooltipSetUnit()
end

return iLvLFrame:RegisterEvent('PLAYER_LOGIN')